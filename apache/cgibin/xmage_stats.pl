...
print BAR_CHART "    }\n";
print BAR_CHART "    getPadding = function(x) {\n";
print BAR_CHART "        return this.options.padding;\n";
print BAR_CHART "    }\n";
...
print BAR_CHART "            //drawBar (this.ctx, this.options.padding + barIndex * barSize, this.canvas.height - barHeight - this.options.padding, barSize, barHeight, this.options.colors[barIndex % this.options.colors.length]);\n";
print BAR_CHART "            //drawBar (this.ctx, barIndex * barSize, this.canvas.height - barHeight, barSize, barHeight, this.options.colors[barIndex % this.options.colors.length]);\n";
